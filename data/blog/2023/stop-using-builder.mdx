---
title: '@Build 사용을 멈춰줘22222'
date: 2023-05-13T15:32:14Z
lastmod: '2023-05-13'
tags: ['java', 'lombok', 'guide']
draft: false
summary: 'Java를 사용할때 Lombok의 @Builder를 이유없이 막 사용하면 안되는 이유'
layout: PostSimple
bibliography: references-data.bib
---

Lombok이 나오면서 Getter, Setter를 직접 작성하거나 IDE의 도움을 받는 시대는 끝이 났습니다.
2222
생각하지 않으며 개발하면서 저는 아래와 유사하게 Lombok을 사용하고 있었죠.
